...
const FuzzyText = ({
  ...
  const { isVeryLowEnd, prefersReducedMotion, effectiveFps } =
    useDeviceCapability();

  // On very-low-end devices or reduced-motion: render plain text instead of canvas


  // Cap FPS on low-end devices
  const actualFps = Math.min(fps, effectiveFps);

  useEffect(() => {
    if (isVeryLowEnd || prefersReducedMotion) return;
    ...
    const init = async () => {
      ...
      const handleMouseMove = (e) => {
        ...
        isHovering = isInsideTextArea(mouseX, mouseY);
      };
      ...
      const handleTouchMove = (e) => {
        ...
        isHovering = isInsideTextArea(touchX, touchY);
      };
